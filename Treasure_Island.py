...
/______/______/______/______/______/______/______/______/______/______/_____ /left
...
if choice_1 == 'left':
    ...
    if choice_2 == 'call':
        print("Your friend is not picking up. Game Over.")
    else:
        choice_3 = input("You can enter the new room. The room is dark and mysterious. Type 'On' to switch on the light. \n").lower()
        if choice_3 == 'on':
            print("You found the treasure! You Win!")
        else:
            print("You are in a dark room and you can't see anything. Game Over.")  